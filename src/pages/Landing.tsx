...
const testimonials = [
  {
    ...
    stars: 4,
    quote:
      "Les recommandations sont claires, adaptées à mon rythme de travail et faciles à suivre. J'ai rapidement repris une routine sportive durable.",
  },
  {
    name: "Sophie P.",
    ...
    avatar: sophieAvatar,
    quote:
      "Je pensais que perdre du poids était impossible. L'application a créé un programme sportif et alimentaire qui s'adapte à mes semaines chargées. Pour la première fois, je suis régulière.",
  },
  {
    name: "Thomas K.",
    ...
    avatar: thomasAvatar,
    quote:
      "Je m'entraînais sans vraie structure et je mangeais 'à peu près bien'. L'application m'a donné un plan clair, cohérent entre sport et alimentation, et les progrès sont enfin visibles.",
  },
];
const faqItems = [
  {
...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      {/* Hero Section - Seamless avec header */}
